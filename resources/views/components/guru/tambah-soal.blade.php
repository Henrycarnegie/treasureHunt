@props(['responseType' => '', 'pekerjaan', 'type_question' => '', 'fullOption'=>''])
    ...
    <div class="relative mx-auto w-full max-w-[24rem] rounded-lg overflow-hidden shadow-sm bg-white" @click.stop>
        <form wire:submit.prevent="simpanSoal">
            ...
            <div class="flex flex-col gap-4 p-6">
                ...
                <x-guru.field-tambah-soal :responseType="$responseType" :fullOption="$fullOption"></x-guru.field-tambah-soal>
            </div>
