@props(['infoLevel', 'infoSoal'=>"1", 'soal'=>"Berapa hasil dari 2+2?"])

@if ( $infoLevel === '1' || $infoLevel === '2' || $infoLevel === '5' )
    ...
    <div x-data="{ openSoal: false }" class=" bg-white rounded-md bg-clip-padding backdrop-filter backdrop-blur-md border-gray-200 shadow-lg px-8 py-6 min-w-full min-h-80">
        <div class="flex w-full" x-show="!openSoal">
            <div class="w-full flex flex-col gap-y-3 justify-center items-center">
                <span class="md:text-2xl font-bold text-orange-600 cursor-default">Box 1</span>
                <img src="{{ asset('img/chest.svg') }}" alt="box-1" class="h-40 cursor-pointer transform transition-transform duration-300 hover:scale-110 p-2" @click="openSoal = true">
            </div>
            <div class="w-full flex flex-col gap-y-3 justify-center items-center">
                <span class="md:text-2xl font-bold text-orange-600 cursor-default">Box 2</span>
                <img src="{{ asset('img/chest.svg') }}" alt="box-2" class="h-40 cursor-pointer transform transition-transform duration-300 hover:scale-110 p-2" @click="openSoal = true">
            </div>
            <div class="w-full flex flex-col gap-y-3 justify-center items-center">
                <span class="md:text-2xl font-bold text-orange-600 cursor-default">Box 3</span>
                <img src="{{ asset('img/chest.svg') }}" alt="box-3" class="h-40 cursor-pointer transform transition-transform duration-300 hover:scale-110 p-2" @click="openSoal = true">
            </div>
            <div class="w-full flex flex-col gap-y-3 justify-center items-center">
                <span class="md:text-2xl font-bold text-orange-600 cursor-default">Box 4</span>
                <img src="{{ asset('img/chest.svg') }}" alt="box-4" class="h-40 cursor-pointer transform transition-transform duration-300 hover:scale-110 p-2" @click="openSoal = true">
            </div>
        </div>
