        ...
        <div class="bg-white dark:bg-gray-900 shadow-md rounded-lg px-8 py-8 min-w-96">
            ...
            <form action="">
                ...
                <button onclick="" type="submit"
                    class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-orange-500 hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">Login</button>
            </form>
        </div>
    </div>
</body>
