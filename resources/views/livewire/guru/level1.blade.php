    ...
    <div class="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-200 mt-14 min-h-screen">
        <div class="grid gap-4 pt-4">
            ...
            <x-guru.modal-soal infoPekerjaan="Polisi">
                <x-guru.content-soal responseType="pilgan" pekerjaan="polisi" type_question="main_question"></x-guru.content-soal>
            </x-guru.modal-soal>
            <x-guru.modal-soal  infoPekerjaan="Detektif">
                <x-guru.content-soal responseType="pilgan" pekerjaan="detektif" type_question="main_question"></x-guru.content-soal>
            </x-guru.modal-soal>
            <x-guru.modal-soal  infoPekerjaan="Nelayan">
                <x-guru.content-soal responseType="pilgan" pekerjaan="nelayan" type_question="main_question"></x-guru.content-soal>
            </x-guru.modal-soal>
